...
class MonitoringService:
    ...
    NUMERICAL_COLS = ['income_expenditure_difference', 'income', 'total_expenses', 'total_income', 
        'loan_term', 'salary_allowance', 'number_of_products_in_use', 'casa_balance', 'number_of_dependents', 
        'age', 'term_deposit_balance', 'number_of_non_credit_products', 'work_tenure', 'bank_debt_balance', 
        'number_of_banks_with_outstanding_debt', 'loan_amount', 'expected_loan_interest', 'duration_of_relationship_with_the_bank', 'proposed_term'
    ]
    CATEGORICAL_COLS = [
        'working_agency', 'type_of_residence', 'bank_product', 'customer_segment', 'marital_status', 
        'educational_level', 'insurance', 'position', 'housing', 'debt_repayment_source', 'labor_contract', 
